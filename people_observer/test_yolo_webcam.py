...
# Purpose: YOLO model performance benchmarking on webcam with FPS, inference time, and memory metrics
# Acknowledgements: Ultralytics YOLO for model variants, Claude for benchmarking implementation
